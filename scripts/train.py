...
for data in train_data_list:
    ...
    train_loss = model.test_on_batch(train_depth,train_joy)
...
for data in val_data_list:
    ...
    val_loss = model.test_on_batch(val_depth,val_joy)
...
for i in range(EPOCHS):
    ...
    for data in train_data_list:
        ...
        train_loss = model.train_on_batch(train_depth,train_joy)
        epoch_train_loss.append(train_loss[0])
